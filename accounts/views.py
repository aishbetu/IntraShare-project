...
from IntraShareApp.models import *
...
def view_profile(request):
    ...
    responses = IntraResponse.objects.filter(name=request.user)
    return render(request, 'IntraShareApp/userProfile.html',
                  {'employments': employments, 'educations': educations, 'responses': responses})


class EmploymentCreateView(BSModalCreateView):
    form_class = EmploymentForm
    template_name = 'registration/add_employment_details.html'
...
class EmploymentDeleteView(BSModalDeleteView):
    model = Employment
    template_name = 'registration/delete_employment_details.html'
...
class EducationCreateView(BSModalCreateView):
    ...
    template_name = 'registration/add_education_details.html'
...
class EducationDeleteView(BSModalDeleteView):
    model = Education
    template_name = 'registration/delete_education_details.html'
